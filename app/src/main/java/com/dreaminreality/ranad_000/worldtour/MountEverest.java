...
public class MountEverest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mount_everest);
        ...
        image.setImageResource(R.drawable.mt_everest);
        title.setText("Mount Everest");
        //title_details.setText("Giza, Egypt");
        content.setText(getString(R.string.mt_everest));
    }
