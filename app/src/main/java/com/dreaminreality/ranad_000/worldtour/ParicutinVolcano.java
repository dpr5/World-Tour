...
public class ParicutinVolcano extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image.setImageResource(R.drawable.paricutin_volcano);
        title.setText("Paricutin Volcano");
        //title_details.setText("Giza, Egypt");
        content.setText(getString(R.string.paricutin_volcano));
    }
