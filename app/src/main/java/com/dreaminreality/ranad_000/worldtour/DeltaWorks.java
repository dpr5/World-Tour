...
public class DeltaWorks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delta_works);
        ...
        image.setImageResource(R.drawable.delta_works);
        title.setText("Delta Works");
        //title_details.setText("Ancient Greece");
        content.setText(getString(R.string.delta_works));
