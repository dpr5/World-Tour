...
public class CNTower extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cntower);
        ...
        image.setImageResource(R.drawable.cn_tower);
        title.setText("CN Tower");
        //title_details.setText("Giza, Egypt");
        content.setText(getString(R.string.cn_tower_text));
    }
