...
public class GrandCanyon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image.setImageResource(R.drawable.grand_canyon);
        title.setText("Grand Canyon");
        //title_details.setText("Giza, Egypt");
        content.setText(getString(R.string.grand_canyon));
    }
