...
public class NaturalWonders extends AppCompatActivity implements RecyclerViewClickListener{
...
//        mToast.show();
        switch (position) {
            case 0:
                Intent act0 = new Intent(NaturalWonders.this, GizaPyramid.class);
                startActivity(act0);
                break;
            case 1:
                Intent act1 = new Intent(NaturalWonders.this, BabylonGardenActivity.class);
                startActivity(act1);
                break;
            case 2:
                Intent act2 = new Intent(NaturalWonders.this, LighthouseAlexandria.class);
                startActivity(act2);
                break;
            case 3:
                Intent act3 = new Intent(NaturalWonders.this, TempleArtemis.class);
                startActivity(act3);
                break;
            case 4:
                Intent act4 = new Intent(NaturalWonders.this, MausoleumHalicarnassus.class);
                startActivity(act4);
                break;
            case 5:
                Intent act5 = new Intent(NaturalWonders.this, ColossusRhodes.class);
                startActivity(act5);
                break;
            case 6:
                Intent act6 = new Intent(NaturalWonders.this, StatueZeus.class);
                startActivity(act6);
                break;
        }
    }
