...
public class ChristRedeemer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_christ_redeemer);
        ...
        image.setImageResource(R.drawable.christ_the_redeemer);
        title.setText("Christ the Redeemer");
        //title_details.setText("Giza, Egypt");
        content.setText(getString(R.string.christ_statue));
    }
