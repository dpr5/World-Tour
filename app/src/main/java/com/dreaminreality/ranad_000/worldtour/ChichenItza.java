...
public class ChichenItza extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chichen_itza);
        ...
        image.setImageResource(R.drawable.chichen_itza_ruins);
        title.setText("Chichen Itza");
        //title_details.setText("Giza, Egypt");
        content.setText(getString(R.string.chichén_itzá));
    }
