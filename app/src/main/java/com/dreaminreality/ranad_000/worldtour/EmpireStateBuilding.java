...
public class EmpireStateBuilding extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_empire_state_building);
        ...
        image.setImageResource(R.drawable.empire_state_building);
        title.setText("Empire State Building");
        //title_details.setText("Ancient Greece");
        content.setText(getString(R.string.empire_state_text));
