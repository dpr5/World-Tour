...
public class ChannelTunnel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_channel_tunnel);
        ...
        image.setImageResource(R.drawable.channel_tunnel);
        title.setText("Channel Tunnel");
