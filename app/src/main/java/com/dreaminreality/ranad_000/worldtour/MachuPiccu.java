...
public class MachuPiccu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_machu_piccu);
        ...
        image.setImageResource(R.drawable.machu_pichu);
        title.setText("Machu Piccu");
        //title_details.setText("Giza, Egypt");
        content.setText(getString(R.string.machu_piccu));
    }
