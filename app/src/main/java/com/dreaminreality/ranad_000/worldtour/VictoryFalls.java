...
public class VictoryFalls extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image.setImageResource(R.drawable.victory_falls);
        title.setText("Victory Falls");
        //title_details.setText("Giza, Egypt");
        content.setText(getString(R.string.victory_falls));
    }
