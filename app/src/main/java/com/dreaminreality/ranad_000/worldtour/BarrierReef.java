...
public class BarrierReef extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image.setImageResource(R.drawable.great_reef);
        title.setText("The Great Barrier Reef");
        //title_details.setText("Giza, Egypt");
        content.setText(getString(R.string.barrier_reef));
    }
